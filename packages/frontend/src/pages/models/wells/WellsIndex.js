...
import { DISPLAY_MODES } from "./WellsConfig";
import config from "./WellsConfig";
import { ConfirmDeleteDialog } from "../../../components/crud/ConfirmDeleteDialog";
import IndexAppBar from "../../../components/crud/IndexAppBar";
import { ROUTES } from "../../../constants";
import { useHistory } from "react-router-dom";

function WellsIndex({ width, modelName }) {
  const app = useApp();
  ...
  return (
    <div style={{ height: "100%" }}>
      ...
      <ConfirmDeleteDialog
        ...
        afterDelete={() => {
          history.push(`${ROUTES.MODEL_WELLS}`);
        }}
      />
...
export default withWidth()(WellsIndex);
