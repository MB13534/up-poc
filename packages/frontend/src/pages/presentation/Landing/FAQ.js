            ...
            <Accordion>
              ...
              >
                <Typography variant="subtitle1">
                  How do I install LRE Water UP PoC Starter Kit?
                </Typography>
              </AccordionSummary>
              <AccordionDetails>
                <Typography variant="subtitle1" color="textSecondary">
                  Installing LRE Water UP PoC Starter Kit is as simple as
                  cloning our repository and running <code>yarn install</code>.{" "}
                  <Link
                    href="https://github.com/lrewater/up-poc"
                    target="_blank"
