    ...
    <Wrapper py={20}>
      ...
      <Container>
        ...
        <Typography variant="h2" component="h3" gutterBottom>
          Why Use LRE Water UP PoC Starter Kit
        </Typography>
        <Box mb={8} />
        <Grid container spacing={6}>
          <Feature
            ...
            description="LRE Water UP PoC Starter Kit is built to make your life easier. Authentication, modeling, theming, build tooling, documentation, and hundreds of components. "
          />
          <Feature
            Icon={PlusCircleIcon}
          ...
          <Feature
            Icon={LayoutIcon}
            title="Material UI"
            description="LRE Water UP PoC Starter Kit uses Material UI, ensuring an adaptable system of components and tools that support the best practices of user interface design."
          />
        </Grid>
