  ...
  return (
    <Box mb={10}>
      ...
      <Typography variant="subtitle1" gutterBottom my={4}>
        LRE Water UP PoC Starter Kit is a React based CMS starter kit themed
        with Material UI. The intention is to provide a standard and robust
        starting point for any project requiring modern content management
        tools.
      </Typography>
      <Typography variant="subtitle1" gutterBottom my={4}>
